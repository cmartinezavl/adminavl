            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="<?php echo $base_url?>views/dashboard" class="header-logo">
                        ...
                        <img src="<?php echo $base_url?>assets/images/authentication/Logo_AVL.png" alt="logo" class="desktop-dark">
        ...
        <div class="header-content-right">
            ...
            <div class="header-element header-theme-mode">
                ...
                <a href="javascript:void(0);" class="header-link layout-setting">
                    <span class="light-layout">
                        ...
                        <i class="bx bx-moon header-link-icon" data-bs-toggle="tooltip"
                            data-bs-custom-class="tooltip-dark" data-bs-placement="bottom" title="Tema Oscuro"></i>
                        <!-- End::header-link-icon -->
                    </span>
                    <span class="dark-layout">
                        <!-- Start::header-link-icon -->
                        <i class="bx bx-sun header-link-icon" data-bs-toggle="tooltip"
                            data-bs-custom-class="tooltip-dark" data-bs-placement="bottom" title="Tema Claro"></i>
                        <!-- End::header-link-icon -->
                    </span>
                </a>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                                            <a href="cart.php">SomeThing Phone</a>
                                        </div>
                                        <div>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                                            <a href="cart.php">Kikon Camera</a>
                                        </div>
                                        <div>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                                            <a href="cart.php">Canvas Shoes</a>
                                        </div>
                                        <div>
                    ...
                    <div class="p-5 empty-item d-none">
                        <div class="text-center">
                            ...
                            <a href="products.php" class="btn btn-primary btn-wave btn-sm m-1" data-abc="true">continue
                    ...
                    <ul class="list-unstyled mb-0" id="header-notification-scroll">
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="notifications.php">Your Order Has Been
                                                Shipped</a></p>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="notifications.php">Discount Available</a>
                                        </p>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="notifications.php">Account Has Been
                                                Verified</a></p>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="notifications.php">Order Placed <span
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="notifications.php">Order Delayed <span
            ...
            <div class="header-element header-fullscreen">
                ...
                <a onclick="openFullscreen();" href="javascript:void(0);" class="header-link">
                    <i class="bx bx-fullscreen full-screen-open header-link-icon" data-bs-toggle="tooltip"
                        data-bs-custom-class="tooltip-dark" data-bs-placement="bottom" title="Pantalla Completa"></i>
            ...
            <div class="header-element">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="<?php echo $base_url?>assets/images/fondos/undraw_profile.png" alt="img" width="32" height="32"
                                class="rounded-circle">
                        </div>
                        <div class="d-sm-block d-none">
                            <p class="fw-semibold mb-0 lh-1" id="nombreNav"><?php echo $_COOKIE['nombre']?> <?php echo $_COOKIE['apellido']?></p>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li><a class="dropdown-item d-flex" href="javascript:void(0);" data-bs-toggle="modal"
                            data-bs-target="#modalConfiuracion"><i
                                class="las la-cog fs-18 me-2 op-7" style="margin-top:1px;"></i>Configuración</a></li>
                    <li><a class="dropdown-item d-flex" href="<?php echo $base_url?>logout.php"><i
                                class="bi bi-door-closed fs-18 me-2 op-7" style="margin-top:-3px;"></i>Cerrar Sesión</a></li>
                </ul>
            </div>
            <!-- End::header-element -->
