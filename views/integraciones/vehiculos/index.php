...
<div class="container-full mt-2 mb-2">
    ...
    <div class="row g-2">
        <div class="col-xl-12">
            ...
            <button class="btn btn-primary" id="modalButton">Modal</button>
        </div>
    </div>
</div>
...
<?php include 'modal-wizard.php'; ?>
<script src="../../../controllers/integraciones/vehiculosController.js"></script>
